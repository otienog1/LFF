                                    ...
                                    <div>
                                        <Link href="https://www.instagram.com/maniagosafaris/">
                                            <span className="flex space-x-3 cursor-pointer">
                                                ...
                                                <span className=""><a>Instagram</a></span>
                                            </span>
                                        </Link>
                                    </div>
                                    <div className="">
                                        <Link href="https://www.facebook.com/ManiagoSafarisEastAfrica">
                                            <span className="flex space-x-3 cursor-pointer">
                                                ...
                                                <span className=""><a>Facebook</a></span>
                                            </span>
                                        </Link>
                                    </div>
                                    <div>
            ...
            <div className="absolute hidden md:block bottom-0">
                <p className="text-sm">
                    <a href="mailto:info@theluigifootprints.org">
                        <span className="font-sorts text-base font-bold">Send us an email: </span> <span>info@theluigifootprints.org</span>
                    </a>
                </p>
            </div>
        </div >
