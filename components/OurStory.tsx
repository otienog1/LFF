                ...
                <div className="block md:flex w-full h-full items-center px-4 md:px-0 py-28">
                    <div className="w-full md:w-5/12 md:pr-24">
                        ...
                        <div className="hidden md:block">
                            <Link href="/our-story" className="mt-16 inline-block px-12 py-6 text-sm tracking-wider shadow bg-lffvegas_600 text-lff_100 font-sen lowercase">
                                Our Story
                            </Link>
                        </div>
                    </div>
                    ...
                    <div className="md:hidden w-full">
                        <Link href="/our-story" className="mt-8 w-full text-center inline-block px-16 py-4 bg-lffvegas_600 text-lff_200 font-sen shadow">
                            Our Story
                        </Link>
                    </div>
                </div>
