                ...
                <div ref={elem} className="pb-28 md:py-0 w-full mx-auto relative md:px-0">
                    <div ref={ctaImage} className="w-full md:w-3/5 mx-auto overflow-hidden relative md:-top-60">
                        ...
                        <div className="flex justify-center relative">
                            <Link href="/donate" scroll={false} className="inline-block px-16 py-5 bg-lffvegas_300 font-bold text-lff_800 cursor-pointer hover:bg-lffvegas_500 transition-all text-sm tracking-widest lowercase">Make a Donation</Link>
                        </div>
                    </div>
                </div>
            </Container>
